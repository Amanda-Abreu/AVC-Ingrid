...
def fazer_encomenda():
    ...
    # Adiciona o item ao carrinho# Lista de produtos no estoque, cada produto tem: (nome, categoria, preço, quantidade)
    # armazem = [
    #     ("Notebook", "Eletrônicos", 3500.00, 10),
    #     ("Camiseta", "Vestuário", 50.00, 100),
    #     ("Smartphone", "Eletrônicos", 2000.00, 15),
    #     ("Calça Jeans", "Vestuário", 120.00, 50)
    # ]
    #
    # # Carrinho de compras (lista de itens no carrinho)
    # carrinho = []
    ...
    #     print("\nEstoque atual:")
    #     for i, produtos in enumerate(armazem):
    #         print(f"{i + 1}. {produtos[0]} (Categoria: {produtos[1]}) -- Preço: R${produtos[2]:.2f} -- Quantidade: {produtos[3]}")
    #
    # # Função para adicionar item ao carrinho
    # def adicionar_ao_carrinho(sumario_produtos, quantidades):
    #     nome, categoria, preco, quantidade_estoque = armazem[sumario_produtos]
    #     if quantidades <= quantidade_estoque:
    #         carrinho.append((nome, quantidades, preco * quantidades))
    #         print(f"{quantidades}x {nome} adicionado(s) ao carrinho.")
    #     else:
    #         print(f"Estoque insuficiente! Apenas {quantidade_estoque} produtos disponíveis.")
    #
    # # Função para exibir o carrinho
    # def exibir_carrinho():
    #     if not carrinho:
    ...
    #
    #     for item in carrinho:
    #         nome_item, quantidade_comprada, _ = item
    #         for i, produtos in enumerate(armazem):
    #             nome, categoria, preco, quantidade_estoque = produtos
    #             if nome == nome_item:
    #                 armazem[i] = (nome, categoria, preco, quantidade_estoque - quantidade_comprada)
    #
    #     print("Compra finalizada com sucesso! Estoque atualizado.")
    #     carrinho.clear()
    #
